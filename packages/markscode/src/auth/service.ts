...
export const OAUTH_DUMMY_KEY = "markscode-oauth-dummy-key"
...
export class AuthService extends ServiceMap.Service<AuthService, AuthService.Service>()("@markscode/Auth") {
