...
const TIPS = [
  ...
  "Create {highlight}markscode.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/markscode/markscode.json{/highlight} for global config",
  ...
  "Run {highlight}markscode serve{/highlight} for headless API access to OpenCode",
