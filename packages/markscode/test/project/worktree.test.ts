      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe(`markscode/${info.name}`)
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe("markscode/my-feature")
          }),
        { git: true },
      ),
    )
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.name).toBeDefined()
            expect(info.branch).toStartWith("markscode/")
      ...
      provideTmpdirInstance(
        () =>
          Effect.gen(function* () {
            ...
            expect(info.branch).toBe("markscode/test-workspace")
