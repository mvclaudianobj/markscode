...
Practical reference for new and migrated Effect code in `packages/markscode`.
...
export class Service extends Context.Service<Service, Interface>()("@markscode/Foo") {}
