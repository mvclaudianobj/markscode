...
Practical reference for the current tool-migration state in `packages/markscode`.
...
Tool tests should use the existing Effect helpers in `packages/markscode/test/lib/effect.ts`:
